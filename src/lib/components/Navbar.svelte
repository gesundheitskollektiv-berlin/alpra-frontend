...
<nav
	class="navbar navbar-expand-xl navbar-light bg-white sticky-top"
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav ms-auto">
				{#if isDetailPage}
					<li class="nav-item">
						<a class="btn-alpra bg-alpra-yellow text-black mx-2" href="/{locale}">
				...
				{:else}
					{#each navItems as item}
						<li class="nav-item">
							<a
								class="btn-alpra bg-alpra-yellow text-black mx-2"
								href={item.href}
